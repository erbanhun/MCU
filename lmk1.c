...
//DCLK12
CLK_SPI04828(0X0130,0X0C);	// 12,13	138.24MHz ,1/16,LVDS
CLK_SPI04828(0X0133,0X00);
CLK_SPI04828(0X0134,0X22);
CLK_SPI04828(0X0136,0X70);
CLK_SPI04828(0X0137,0X55);
...
CLK_SPI04828(0X0140,0X09);//?SYSREF_PLSR_PD=0,sysref_pd=0,sysref_ddly_pd=0,	 sysref_plsr_pd=0
